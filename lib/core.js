(function (root, factory) {
  ...
  const COMMANDS = Object.freeze({
    play: (playerId) => command("players/cmd/play", { player_id: playerId }),
    pause: (playerId) => command("players/cmd/pause", { player_id: playerId }),
    stop: (playerId) => command("players/cmd/stop", { player_id: playerId }),
  ...
  function notificationAction(notification) {
    return ({
      ...
      MUSIC_PAUSE: "pause",
      MUSIC_STOP: "stop",
      MUSIC_PLAY_URI: "playUri",
      MUSIC_SET_VOLUME: "setVolume",
      MUSIC_SELECT_PLAYER: "selectPlayer",
